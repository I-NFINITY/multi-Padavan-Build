...
user_name="root"                                   # 用户名
user_password="Abcd258741"                               # 登录密码
lan_ip="192.168.1"                                  # LAN 地址 别写后面的 .1
wlan_2g_ssid="YouZiYouWei"                              # 2G 无线名称
wlan_5g_ssid="YouZiYouWei_5G"                           # 5G 无线名称
wlan_guest_2g_ssid="YouZiYouWei_Guset"                  # 2G 访客无线名称
wlan_guest_5g_ssid="YouZiYouWei_Guest_5G"               # 5G 访客无线名称
wlan_2g_psk="Abcd258741"                            # 2G WIFI密码最少8位 空白为不设置
wlan_5g_psk="Abcd258741"                            # 5G WIFI密码最少8位 空白为不设置
